...
| Hybrid RAG | Independent semantic and keyword recall, Reciprocal Rank Fusion, reranking, relevance gating, parent/adjacent expansion, and context deduplication | [Knowledge / RAG](docs/knowledge-rag.md) |
...
| **Implemented** | RAG | Markdown ingestion, source traceability, independent Semantic/Keyword recall, RRF, reranking, relevance gate, parent/adjacent context selection, deduplication, and merging |
...
| **Planned** | Grounding | Native `[S1]` citations are implemented in [PR #37](https://github.com/hoiyd/agentflow-platform/pull/37) but not yet on `main`; evidence-bound no-answer validation follows |
