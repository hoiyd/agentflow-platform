...
| [Answer relevance calibration](docs/operations/offline-evaluation.md#answer-relevance-calibration) | The production verifier is calibrated on labeled question/answer pairs with a frozen calibration/holdout split; unsafe profiles remain advisory instead of becoming an unproven Completion Gate | [runner](apps/api/internal/evaluation/relevanceeval/runner.go), [dataset](examples/verification/answer-relevance-dataset.v1.json), [evidence](examples/verification/evidence/qwen3-embedding-answer-relevance.v1.json) |
...
| [**Evidence-backed benchmark suite**](docs/operations/offline-evaluation.md#case-001a-live-model-benchmark-evidence) | A fixed 12-task manifest connects deterministic regression evidence with an opt-in, budgeted live RAG/Tool/Router comparison pack | [manifest](examples/benchmark-suite.v1.json), [offline evidence](scripts/benchmark-evidence.sh), [live CLI](apps/api/cmd/eval/live_benchmark.go) |
