...
| [Offline evaluation reports](operations/offline-evaluation.md) | How do Context, Agent routing, Tool, RAG, and Answer Relevance evaluations share provenance, failure accounting, regression gates, and opt-in live profiles? |
