.PHONY: help setup quickstart dev test golden-eval context-eval reference-eval
...
help:
	@printf '%s\n' \
	  ...
	  'make reference-eval Build the offline CASE-001 evidence pack' \
...
reference-eval:
	@bash scripts/reference-task.sh
