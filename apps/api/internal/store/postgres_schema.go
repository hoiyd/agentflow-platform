...
var postgresRequiredColumns = []postgresColumnRequirement{
	...
	{Table: "run_delegations", Column: "parent_run_id"},
	{Table: "run_delegations", Column: "child_run_id"},
	{Table: "run_delegations", Column: "block_reason", UDTName: "text", NotNull: true},
	...
	{Table: "tool_effects", Column: "version", UDTName: "int8", NotNull: true},
	{Table: "tool_effects", Column: "status", UDTName: "text", NotNull: true},
	{Table: "tool_effects", Column: "definition_revision", UDTName: "text", NotNull: true},
	{Table: "tool_effects", Column: "result", UDTName: "bytea"},
	{Table: "tool_artifacts", Column: "run_id", UDTName: "text", NotNull: true},
	{Table: "tool_artifacts", Column: "tool_call_id", UDTName: "text", NotNull: true},
	...
	{Table: "documents", Column: "chunker_version", UDTName: "text", NotNull: true},
	{Table: "documents", Column: "embedding_provider", UDTName: "text", NotNull: true},
	{Table: "documents", Column: "embedding_model", UDTName: "text", NotNull: true},
	{Table: "documents", Column: "embedding_dimensions", UDTName: "int4", NotNull: true},
	...
	{Table: "task_state_revisions", Column: "state", UDTName: "jsonb", NotNull: true},
	{Table: "task_state_revisions", Column: "source", UDTName: "jsonb", NotNull: true},
}
