...
func (s *Service) ToolBindings() []tool.Binding {
	...
	return []tool.Binding{s.readBinding(), s.searchBinding()}
}
...
func (s *Service) readBinding() tool.Binding {
	return tool.Binding{
		Descriptor: tool.Descriptor{
			...
			Concurrency: tool.ConcurrencyPolicy{Mode: tool.ConcurrencyReadOnly},
			Security: policy.NormalizeCapability(policy.Capability{Scope: policy.Scope{Resources: []policy.ResourceScope{{
				Kind: policy.ResourceRun, Name: "tool_artifact", Access: policy.AccessRead,
			}}}}),
...
func (s *Service) searchBinding() tool.Binding {
	return tool.Binding{
		Descriptor: tool.Descriptor{
			Name:        SearchToolName,
