...
func TestDocumentIngestAndRAGSearchAPI(t *testing.T) {
	...
	if searchResponse.RelevanceGate.Policy != "heuristic" || searchResponse.RelevanceGate.Version != "heuristic-relevance-gate-v2" || searchResponse.RelevanceGate.ConfigVersion != "heuristic-relevance-calibrated-v1" {
