...
func TestDocumentIngestAndRAGSearchAPI(t *testing.T) {
	...
	if searchResponse.RelevanceGate.Policy != "heuristic" || searchResponse.RelevanceGate.Version != "heuristic-relevance-gate-v3" || searchResponse.RelevanceGate.ConfigVersion != "heuristic-relevance-hardened-v2" {
