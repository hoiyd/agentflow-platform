...
func TestRecorderFailurePreventsProviderRequest(t *testing.T) {
	client := retryTestClient()
	transportCalls := 0
	client.SetRequestRecorder(requestRecorderFunc(func(context.Context, requestcontrol.Observation) error {
...
type requestRecorderFunc func(context.Context, requestcontrol.Observation) error

func (f requestRecorderFunc) Record(ctx context.Context, observation requestcontrol.Observation) error {
