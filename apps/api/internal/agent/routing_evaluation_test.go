...
func TestRoutingEvaluationUsesProductionGateAndFallback(t *testing.T) {
	...
	selected := EvaluateAgentRouting(RoutingEvaluationInput{Agents: agents, Catalog: tool.DefaultCatalog(), Task: "Implement and test a Go API",
	...
	fallback := EvaluateAgentRouting(RoutingEvaluationInput{Agents: agents, Catalog: tool.DefaultCatalog(), Task: "Research market pricing sources",
	...
	failed := EvaluateAgentRouting(RoutingEvaluationInput{Agents: agents, Catalog: tool.DefaultCatalog(), Task: "Research market pricing sources",
...
func TestRoutingEvaluationRejectsInvalidRequirements(t *testing.T) {
	result := EvaluateAgentRouting(RoutingEvaluationInput{Agents: store.DefaultAgents(time.Now().UTC()), Catalog: tool.DefaultCatalog(),
		RouterMode:   RouterModeQuery,
