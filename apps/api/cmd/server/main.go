...
func main() {
	...
	handler.SetContextAssemblyConfig(domain.ContextAssemblyConfig{
		...
		KnowledgeMaxTokens: cfg.ContextKnowledgeMaxTokens, CompactionMode: cfg.ContextCompactionMode,
		...
		CompactionToolResultMaxTokens: cfg.ContextCompactionToolResultMaxTokens,
	...
	log.Printf("AgentFlow context policy: window=%d output_reserve=%d safety_margin=%d history_max=%d memory_max=%d knowledge_max=%d compaction=%s soft=%.2f hard=%.2f recent=%d summary_max=%d tool_result_max=%d", cfg.ModelContextWindowTokens, cfg.ModelOutputReserveTokens, cfg.ContextSafetyMarginTokens, cfg.ContextHistoryMaxTokens, cfg.ContextMemoryMaxTokens, cfg.ContextKnowledgeMaxTokens, cfg.ContextCompactionMode, cfg.ContextCompactionSoftThreshold, cfg.ContextCompactionHardThreshold, cfg.ContextCompactionRecentTokens, cfg.ContextCompactionSummaryMaxTokens, cfg.ContextCompactionToolResultMaxTokens)
	if cfg.OpenAIAPIKey == "" {
